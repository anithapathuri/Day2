    ...
    return(
        <div className="card" style={{margin:"50px"}}>
            ...
            <div className="card-body" style={{ display: 'flex', alignItems: 'flex-start'}}>
                <img src="S23.jpeg" alt="pleasant" style={{ width: '250px', height: '250px', marginRight: '40px'}}/>
                <div>
            ...
            <div classname="card body">
            <h4>Reviews</h4>
            <input type="text" placeholder="Type to Review" value={review} onChange={value} style={{width:"80rem"}}/>
